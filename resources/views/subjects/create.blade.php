            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('subjects.store') }}">
                        ...
                        <div class="form-group row mb-3">
                            <label for="centre_id" class="col-md-4 col-form-label text-md-right">Centre</label>
                            <div class="col-md-6">
                                <select id="centre_id" class="form-control @error('centre_id') is-invalid @enderror" name="centre_id" required>
