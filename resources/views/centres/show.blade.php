...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Centre Details</h1>
        <div>
            <a href="{{ route('centres.edit', $centre->id) }}" class="btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-edit fa-sm text-white-50"></i> Edit Centre
            </a>
            <a href="{{ route('centres.index') }}" class="btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Centre Information</h6>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Created At</th>
                            <td>{{ $centre->created_at->format('d M Y, h:i A') }}</td>
                        </tr>
                        <tr>
                            <th>Updated At</th>
                            <td>{{ $centre->updated_at->format('d M Y, h:i A') }}</td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Centre Statistics</h6>
                </div>
                <div class="card-body">
                    <div class="row">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="schedulesTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @forelse($centre->lessonSchedules as $schedule)
                            <tr>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No lesson schedules found for this centre.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
