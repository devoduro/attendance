...
<head>
    ...
    <title>{{ config('app.name', 'Transcript System') }} - Login</title>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <div class="flex justify-center mb-8">
                <div class="text-center">
                    <h1 class="text-3xl font-bold gradient-text mb-1">Attendance System</h1>
            ...
            <div class="mt-6 flex items-center justify-center">
                <div class="text-sm">
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:text-primary-500 ml-1">
                            Register now
                        </a>
                    @endif
                </div>
