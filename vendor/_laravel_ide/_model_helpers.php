...
namespace App\Models {
    ...
    /**
     * App\Models\LessonRescheduleRequest
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @property mixed $requested_lesson_section_id
     * @property mixed $current_lesson_schedule_id
     * @property mixed $student_id
     * @property mixed $user_id
     * @property int $id
     * @property-read \App\Models\User $user
     * @property-read \App\Models\Student $student
     * @property-read \App\Models\LessonSchedule $currentLessonSchedule
     * @property-read \App\Models\LessonSection $requestedLessonSection
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereStudentId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereCurrentLessonScheduleId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereRequestedLessonSectionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereReason($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereAdminNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<LessonRescheduleRequest>|LessonRescheduleRequest query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class LessonRescheduleRequest extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<LessonSchedule>|LessonSchedule whereSubjectId($value)
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property boolean $repeat_weekly
     * @property boolean $is_active
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<LessonSection>|LessonSection whereRepeatWeekly($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Subject>|Subject whereCentreId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Teacher>|Teacher whereCentreId($value)
